...
public class PizzaOrder
{
	public static void main (String [] args)
	{
      ...
      { 
        ...
        cost = 12.99;
        inches= 12;
        System.out.print("Not one of the choices. Ordering a 12-inch.\n");
        break;
      }
      ...
      {
         System.out.println("Hand-tossed crust selected.");
      ...
      {
         System.out.println("Deep dish pizza selected.");
         
      }
      else
      {
         System.out.println("Incorrect type selected." +
                            "Defaulting to hand_tossed.");
		...
		if (discount) {cost-=2;}//Remove discount of 2 dollars
		//EDIT PROGRAM FOR TASK #5
		//SO ALL MONEY OUTPUT APPEARS WITH 2 DECIMAL PLACES
		System.out.println("The cost of your order is: $" + decFormat.format(cost));
			
		//calculate and display tax and total cost
		tax = cost * TAX_RATE;
		System.out.println("The tax is:  $" + decFormat.format(tax));
		System.out.println("The total due is:  $" + decFormat.format((tax+cost)));
